...
from app.utils.minio import getClient, uploadImage
import shutil
import os
...
@router.post("/users/me/upload-profile-picture", response_model=UploadProfilePicResponse, name="upload_profile_pic", tags=["User Profile"])
